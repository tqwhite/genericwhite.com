...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-define/tree/v1.0.8/docs/types.propDefinition.md">source</a></li>
...
function.  Constructor functions are identified with [can-util/js/types/types.isConstructor].</p>
