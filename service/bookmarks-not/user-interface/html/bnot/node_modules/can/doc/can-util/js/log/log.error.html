...
<!--####################################################################
	...
	@function can-util/js/log/log.error
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
needed in production. In production these functions become noops.">
	...
	<ul>
					...
					<li class="current
						...
						<a class="function"
							href="log.error.html"
							title="Adds an error message to the console.
canLog.error(new Error(&quot;Oh no!&quot;));">
					...
					<li class="
						...
						<a class="function"
							href="log.log.html"
							title="Adds a message to the console.
canLog.log(&quot;hi&quot;);">
							log
						</a>
					...
					<li class="
						...
						<a class="function"
							href="log.warn.html"
							title="Adds a warning message to the console.
...
<div class="breadcrumb">
	...
	<li><a href="log.error.html">error</a></li>
  ...
  <section class="title">
    ...
    <p>Adds an error message to the console.</p>
<pre><code>canLog.error(new Error(&quot;Oh no!&quot;));
</code></pre>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.2.0/js/log/log.js#L63">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>err</b> <code>{String|Error}</code>: <p>The error to be logged.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/log/log.error","parent":"can-util/js/log/log","src":{"line":63,"codeLine":76,"path":"node_modules/can-util/js/log/log.js"},"description":" Adds an error message to the console.\n\n```\ncanLog.error(new Error(\"Oh no!\"));\n```\n\n","title":"error","signatures":[{"code":"canLog.error(err)","description":"","params":[{"types":[{"type":"String"},{"type":"Error"}],"name":"err","description":"The error to be logged.\n"}]}],"_curParam":{"types":[{"type":"String"},{"type":"Error"}],"name":"err","description":"The error to be logged.\n"},"pathToRoot":"../../../.."};
</script>
</article>
