...
<section class="title-footer">
		...
		<ul class="title-social">
			<li>
				<a class="npm-button" href="https://www.npmjs.com/package/can-view-model">
					<img src="https://img.shields.io/badge/npm%20package-3.1.3-brightgreen.svg" alt="npm package badge" />
				</a>
			</li>
			<li>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-view-model/tree/v3.1.3/can-view-model.md">source</a></li>
...
<div class="signature">
  ...
  <p>Gets the map instance associated with <strong>element</strong>, creating one as a [can-util/js/types/types.DefaultMap] if it doesn't already exist, and returns the map.</p>
...
<div class="signature">
  ...
  <p>Gets the map instance associated with <strong>element</strong>, creating one as a [can-util/js/types/types.DefaultMap] if it doesn't already exist. Then gets the <strong>property</strong> inside of the ViewModel and returns that.</p>
...
<div class="signature">
  ...
  <p>Gets the map instance associated with <strong>element</strong>, creating one as a [can-util/js/types/types.DefaultMap] if it doesn't already exist. Sets the <strong>property</strong> on that map to <strong>value</strong>.</p>
