...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.2/docs/can-guides/introduction/mission.md">source</a></li>
...
keep innovating for 10 years (while still providing a viable upgrade path) and what we’re doing now to make CanJS even more stable moving forward.</li>
</ul>
...
<ul>
<li>End up getting replaced by a <em>hot new</em> framework.</li>
...
increases over time, but doesn’t take large steps backward.  That looks something like this:</p>
...
that take our community by storm every one or two years.</p>
<blockquote>
...
next revolutionary framework emerges.  Instead of the old framework adopting new ideas, the community and its attention move onto the next <em>hot</em> framework.</p>
...
limited effort.</p>
<p>Let’s see how one piece of CanJS, <a href="../can-control.html" title="Create organized, memory-leak free, rapidly performing, stateful controls with declarative event binding. Use Control to create UI
...
<p><span line-highlight='1,7'></span>
<strong>In 2012</strong>, using CanJS 1.0, this became:</p>
...
<p><span line-highlight='1,7'></span>
<strong>In 2013</strong>, we released CanJS 2.0, and transitioned to
...
<p><span line-highlight='1,3,9'></span>
...
<li>RESTful APIs eventually became the best practice for designing a backend interface. <a href="//v2.canjs.com/docs/can.Model.html">can-model</a> in 2010 provided ActiveRecord style abstractions around this pattern.</li>
...
<li>In early 2016, CanJS added real-time support and advanced caching technology with <a href="../can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">can-connect</a>.</li>
<li>In late 2016, CanJS added a more powerful <a href="../can-define.html" title="Exports the define method that defines observable properties and their behavior on a prototype object.">observable type</a> and enabled it to use
...
<p>CanJS 3.0 has been reorganized into several different dozen independent repositories,
each with its own npm package and version number using <a href="http://semver.org/">Semantic Versioning</a>.
Organizing CanJS into individual repositories will improve
CanJS’s stability and innovation going forward.</p>
<h4>Stability</h4>
<p>Independent repositories improve stability because they make it easier to upgrade
...
they’re no longer included in the core CanJS build.</p>
<h4>Innovation</h4>
...
in the core and infrastructure libraries.</li>
