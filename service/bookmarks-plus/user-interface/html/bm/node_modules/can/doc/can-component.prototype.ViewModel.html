...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-component/tree/v3.0.4/docs/ViewModel.md">source</a></li>
...
[can-util/js/types/types.DefaultMap default Map type] (typically <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>)
