...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.18/can/map/map.js#L143">source</a></li>
...
then [can-util/js/types/types.DefaultList] if <code>connection.List</code> is not specified.</p>
