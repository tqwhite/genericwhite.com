...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.18/constructor/constructor.js#L107">source</a></li>
...
<div class="signature">
  ...
  <p>The <code>cidStore</code> is used to temporarily hold references to instances by <a href="../../can-util/js/cid/cid.html" title="Deprecated. Use can-cid instead.">can-util/js/cid/cid</a> that don't
