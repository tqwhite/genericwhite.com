...
<div class="breadcrumb">
	...
	<li><a href="can-types.isCompute.html">isCompute</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.2/node_modules/can-types/can-types.js#L90">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-types.isCompute","parent":"can-types","src":{"line":90,"codeLine":97,"path":"node_modules/can-types/can-types.js"},"description":"","title":"isCompute","signatures":[{"code":"types.isCompute(obj)","description":"\n  Returns true if `obj` is a [can-compute].\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a [can-compute].\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a [can-compute].\n "},"pathToRoot":".."};
</script>
</article>
