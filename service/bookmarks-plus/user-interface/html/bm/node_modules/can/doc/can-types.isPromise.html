...
<div class="breadcrumb">
	...
	<li><a href="can-types.isPromise.html">isPromise</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.2/node_modules/can-types/can-types.js#L51">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-types.isPromise","parent":"can-types","src":{"line":51,"codeLine":58,"path":"node_modules/can-types/can-types.js"},"description":"","title":"isPromise","signatures":[{"code":"types.isPromise(obj)","description":"\n  Returns true if `obj` is a Promise.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a Promise.\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a Promise.\n "},"pathToRoot":".."};
</script>
</article>
