	...
	<ul>
					...
					<li class="
						...
						<a class="module"
							...
							title="Utilities for logging development-mode messages. Use this module for
...
needed in production. In production these functions become noops.">
					...
					<li class="
						...
						<a class="module"
							...
							title="Utilities for logging to the console.">
							./log/
						</a>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-util/dom/ajax/ajax.html"
...
var domData = require(&quot;can-util/dom/data/data&quot;);">
					...
					<li class="
           						...
           						">
						<a class="module"
							href="can-util/dom/document/document.html"
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.2.0/doc/can-util.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-util/doc/can-util.md"},"description":"\nCommon JavaScript utilities for the rest of CanJS.\n","type":"module","title":"","types":[{"type":"Object","options":[]}],"name":"can-util","parent":"can-infrastructure","package":{"author":{"name":"Bitovi","email":"contact@bitovi.com","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.3","bit-docs-generate-readme":"^0.0.8"},"glob":{"pattern":"**/*.{js,md}","ignore":["node_modules/**/*","**/*{-,_,}{test,qunit}{s,}.js"]},"readme":{"apis":"./doc/apis.json"},"parent":"can-util"},"bugs":{"url":"https://github.com/canjs/can-util/issues"},"dependencies":{"can-cid":"^1.0.0","can-namespace":"1.0.0","can-types":"^1.0.1"},"description":"Common utilities for CanJS projects","devDependencies":{"bit-docs":"0.0.7","done-serve":"^0.2.4","donejs-cli":"^0.9.5","generator-donejs":"^0.9.0","jshint":"^2.9.1","mocha":"^3.0.2","mocha-qunit-ui":"^0.1.2","steal":"^1.0.4","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.3.0"},"directories":{},"dist":{"shasum":"c4f4b33e2f378aa63b943e5e58ee861844de81e8","tarball":"https://registry.npmjs.org/can-util/-/can-util-3.2.0.tgz"},"gitHead":"6a0be00541ddc5d1f571d5f6b0dbabf1b81039f5","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-util","maintainers":[{"name":"phillipskevin","email":"kphillips86@gmail.com"}],"name":"can-util","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-util.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint dom/. js/. *.js --config","mocha":"mocha --reporter dot --ui mocha-qunit-ui js/tests","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run jshint && npm run mocha && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"3.2.0"},"pathToRoot":".."};
</script>
</article>
