...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Utilities for logging development-mode messages. Use this module for
anything that should be shown to the user during development but isn't
needed in production. In production these functions become noops.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.2.0/js/dev/dev.js#L2">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/js/dev/dev","type":"module","parent":"can-util/js","src":{"line":2,"codeLine":10,"path":"node_modules/can-util/js/dev/dev.js"},"description":"\nUtilities for logging development-mode messages. Use this module for\nanything that should be shown to the user during development but isn't\nneeded in production. In production these functions become noops.\n","title":"dev","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
