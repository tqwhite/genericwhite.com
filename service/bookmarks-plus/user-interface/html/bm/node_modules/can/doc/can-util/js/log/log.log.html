...
<!--####################################################################
	...
	@function can-util/js/log/log.log
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="log.log.html">log</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.2.0/js/log/log.js#L38">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>msg</b> <code>{String}</code>: <p>the message</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/log/log.log","parent":"can-util/js/log/log","src":{"line":38,"codeLine":51,"path":"node_modules/can-util/js/log/log.js"},"description":" Adds a message to the console.\n\n```\ncanLog.log(\"hi\");\n```\n\n","title":"log","signatures":[{"code":"canLog.log(msg)","description":"","params":[{"types":[{"type":"String"}],"name":"msg","description":"the message\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"msg","description":"the message\n"},"pathToRoot":"../../../.."};
</script>
</article>
