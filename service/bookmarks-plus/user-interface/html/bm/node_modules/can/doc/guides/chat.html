...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.2/docs/can-guides/experiment/chat/chat.md">source</a></li>
...
<p>In this section, we will:</p>
<ul>
<li>Display messages from <a href="http://chat.donejs.com/api/messages">http://chat.donejs.com/api/messages</a> when <code>messagesPromise.isResolved</code>.</li>
...
and then connecting it to a messages service at <code>http://chat.donejs.com/api/messages</code>.</p>
<h3>Explanation</h3>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/experiment/chat/chat.md"},"description":"This guide will walk you through building a real-time chat application with CanJS’s [can-core Core libraries].  It takes about 30 minutes to complete.\n\n","name":"guides/chat","title":"Chat Guide","type":"page","parent":"guides/experiment","order":1,"templateRender":["<%","%>"],"comment":" ","pathToRoot":"../.."};
</script>
</article>
