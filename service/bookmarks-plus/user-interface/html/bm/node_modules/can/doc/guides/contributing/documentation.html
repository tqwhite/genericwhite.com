...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.2/docs/can-guides/contribute/documentation.md">source</a></li>
...
<ol>
<li>Open <code>canjs/package.json</code>. Update <code>bit-docs-html-canjs</code>’s version to the new theme version.</li>
